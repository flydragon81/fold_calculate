...
from fold.helpers import create_point_by_line_point_idx, create_point_by_easting_northing
...
class Grid:
    ...
    def bin_xy2cr(self, rotated: Point):
        ...
        b.column = c
        b.row = r
        b.easting = self.__x0 + c * self.__dxb
        b.northing = self.__y0 + r * self.__dyb
